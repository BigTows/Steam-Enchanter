...
class AxiosHttpClient implements HttpClient {
    ...
    private async executeRequest<R>(configuration: AxiosRequestConfig, options?: HttpClientOptions<R>): Promise<R> {
        ...
        try {
            ...
            return this.processRetries<R>(configuration, options, err);
        }
    ...
    private async processRetries<R>(configuration: AxiosRequestConfig, options?: HttpClientOptions<R>, err?: any): Promise<R> {
